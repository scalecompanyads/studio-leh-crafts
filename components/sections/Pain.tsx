    ...
    <section className="relative overflow-hidden bg-cream py-20 md:py-28">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <FadeIn delay={140}>
            <p className="text-dark/65 text-[17px] leading-relaxed mb-4 max-w-xl mx-auto">
            ...
            <ul className="flex flex-col gap-1.5 mb-6 max-w-xs mx-auto text-left">
              {collectionItems.map((item) => (
                <li key={item} className="flex items-center gap-2 text-dark/75 text-[16px]">
                  <span className="text-primary font-bold">—</span>
                  {item}
                </li>
              ))}
            </ul>
            <p className="text-dark/65 text-[16px] leading-relaxed mb-10 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-12 max-w-3xl mx-auto">
            {resultItems.map((item, i) => (
              <FadeIn key={item} delay={220 + i * 60}>
                <div className="relative overflow-hidden flex items-start gap-3 bg-white border border-dark/8 rounded-xl px-5 py-5 text-left shadow-card hover:-translate-y-0.5 hover:shadow-card-hover hover:border-primary/25 transition-all duration-300 h-full">
                  ...
                  <p className="text-dark/80 text-[14px] leading-snug">{item}</p>
                </div>
              </FadeIn>
            ))}
          </div>
          ...
          <FadeIn delay={600}>
            <p className="text-dark font-semibold text-[17px]">
